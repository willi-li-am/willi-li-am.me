        ...
        <div className="flex flex-row items-center fixed" style={navbarState? NavbarOut : NavbarIn}>
            <div className = "flex flex-col items-center bg-file text-black" style={{width: "300px", height: "100vh", boxShadow: navbarState? "1px 0px 10px black" : "1px 0px 5px black"}}>
                ...
                <div className="" style={{height: "100%", paddingTop: "60px", width: "300px", paddingLeft: "10px", paddingRight: "10px"}}>
                    <Link folderChange = {props.folderChange} folderSelect = {props.folderSelect} zIndexFolders = {props.zIndexFolders} setDirectory = {setDirectory} position = {{x: 35, y: 0}} image = "https://static-00.iconduck.com/assets.00/folder-icon-1024x820-za5s76tx.png" title = "Skills"></Link>
                    <Link folderChange = {props.folderChange} folderSelect = {props.folderSelect} zIndexFolders = {props.zIndexFolders} setDirectory = {setDirectory} position = {{x: 160, y: 0}} image = "https://static-00.iconduck.com/assets.00/folder-icon-1024x820-za5s76tx.png" title = "Projects"></Link>
                    <Link folderChange = {props.folderChange} folderSelect = {props.folderSelect} zIndexFolders = {props.zIndexFolders} setDirectory = {setDirectory} position = {{x: 35, y: 120}} image = "https://upload.wikimedia.org/wikipedia/commons/thumb/8/87/PDF_file_icon.svg/1667px-PDF_file_icon.svg.png" title = "Resume"></Link>
                    <Link folderChange = {props.folderChange} folderSelect = {props.folderSelect} zIndexFolders = {props.zIndexFolders} setDirectory = {setDirectory} position = {{x: 160, y: 120}} image = "https://upload.wikimedia.org/wikipedia/commons/d/d5/Contacts_%28iOS%29.png" title = "Contact Me"></Link>
                </div>
            </div>
