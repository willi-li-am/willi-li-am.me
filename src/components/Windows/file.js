...
export default function File(props){
    ...
    return(
        <Draggable onStart={() => {select(); props.folderSelect(props.title)}} bounds = ".windowInside" defaultPosition={props.position}>
            <div ref={folderRef} onClick = {() => {select(); props.folderSelect(props.title)}} className={"absolute flex flex-col justify-around items-center hover:cursor-pointer"} style={{zIndex: index, width: "80px", padding: "5px", paddingBottom: "5px", paddingTop: "10px"}}>
