...
export default function WindowTop(props) {
    ...
    return(
        <div id = "topWindow" className="flex flex-row justify-between hover:cursor-grab select-none" style={{height: "30px", padding: "2.5px", paddingLeft: "15px", paddingRight: 0}}>{/** top window part with buttons and shit */}
